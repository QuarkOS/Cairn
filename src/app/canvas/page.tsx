...
import type { CanvasLayout } from "@/lib/cairn/canvas";
import {
  formatValue,
  podKeyForBelief,
...
export default function CanvasPage() {
  ...
  const [layout, setLayout] = useState<CanvasLayout>({ version: 1, pods: {} });
  ...
  function persistLayout(next: CanvasLayout) {
    setLayout(next);
